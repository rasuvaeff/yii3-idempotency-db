...
```
M260611000000CreateIdempotencyKeysTable
→ Rasuvaeff\Yii3IdempotencyDb\Migration\M260611000000CreateIdempotencyKeysTable
```
...
```sql
UPDATE migration
SET name = 'Rasuvaeff\\Yii3IdempotencyDb\\Migration\\M260611000000CreateIdempotencyKeysTable'
WHERE name = 'M260611000000CreateIdempotencyKeysTable';
```
...
-    'setSourcePaths()' => [[__DIR__ . '/../vendor/rasuvaeff/yii3-idempotency-db/migrations']],
